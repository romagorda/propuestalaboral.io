...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2025 a las 22:09:58
...
INSERT INTO `favoritos` (`id`, `usuario_id`, `propuesta_id`) VALUES
(36, 10, 6),
(35, 10, 7),
(34, 10, 8),
(33, 10, 9),
...
INSERT INTO `login` (`id`, `nombre_usuario`, `gmail`, `avatar_url`, `contraseña`, `rol`) VALUES
(5, 'romagorda', 'romanquiroga456@gmail.com', NULL, '$2y$10$9/NMyKCKicqWQQRd8cMdHOEs6h6qMeJv8hfbwpzSZQa9A4yH056P2', 'admin'),
(6, 'troll', 'troll345@gmail.com', NULL, '$2y$10$ADEgy.sFclKKHxPepYJcSeq9O2GdXEf9XRQa0eF3AzVtopJBB1SeS', 'usuario'),
(7, 'pelotudo', 'pelotudo123@gmail.com', NULL, '$2y$10$29dn1DOMzhmpwJkivt70zOJ7HwxPddK0dovon5f5mxjpWbCp9dYgO', 'usuario'),
(8, 'rata', 'rata123@gmail.com', NULL, '$2y$10$t95AgtU.8zeHuZ4/uZA/IePmlXituj33/M954TvxE3BvY8M4NwssC', 'usuario'),
(9, 'roberto', 'robertito@gmail.com', NULL, '$2y$10$ygK94ydcojk1ea0yFDjMd.feCCoxSqH7znhyo75iIl/FTnBRhzql.', 'usuario'),
(10, 'Joamst25', 'marekjoaco@gmail.com', 'uploads/avatars/avatar_10_1759704318.webp', '$2y$10$rLwxeBeNH.Yfo8AdvCHq2uhrAx0ZxC8MtLHs45LPTySTdYwIUgiBO', 'admin'),
(11, 'Jota', 'prueba@gmail.com', 'uploads/avatars/avatar_11_1759690167.png', '$2y$10$0XyBoIWFAVp4hXfAoCFCdOKdnrot44y/VYhL58RfymPzzdBQQVrta', 'usuario');
...
INSERT INTO `propuestas` (`id`, `propuesta`, `localidad`, `descripcion`, `contacto`, `categoria`, `usuario_id`) VALUES
(2, 'PROFESOR', 'Santa Teresita', 'SE NECESITA PROFE DE EDUCACION FISICA EN LA 12', '2257500653', '', NULL),
(4, 'Diseñador web', 'La Lucila', 'Necesito un DW', '2246440318', 'Diseño', NULL),
(5, 'Podador', 'Mar del Tuyu', 'Necesito que alguien me corte el pasto entre las 15hs y las 17hs', 'prueba@gmail.com', 'Recursos Humanos', NULL),
(6, 'Niñero', 'Santa Teresita', 'Necesito alguien que cuide a mi hijo a las 10am', '2246440319', 'Recursos Humanos', NULL),
(7, 'rapero', 'Santa Teresita', 'necesito un rapper gansta', '2246440318', 'Tecnología', 10),
(8, 'servicio de limpieza', 'Santa Teresita', 'necesito que limpien mi casa en cualquier momento del dia. ', '2246567876', 'Recursos Humanos', 11),
(9, 'ff', 'fff', 'hh', 'hh', 'Diseño', 11),
(10, 'dd', 'dds', 'dsd', 'sdsd', 'Tecnología', 11),
(11, 'www', 'www', 'www', 'www', 'Tecnología', 11);
